...
//  合约地址
const UNIVERSAL_POINTS_ADDRESS = "0xA313B37296AE8D1304271b9e595e6558B57B77bf";
const POINTS_EXCHANGE_ADDRESS  = "0xFc3f31cB4843647428aef0362d082a55E14Be782";
      ...
      {!isWalletConnected ? (
        ...
        <div className="center-container">
          ...
          <div className="section">
            ...
            />
            <button className="primary-button" onClick={handleDeploy}>
              部署通用积分发行合约
            </button>
          </div>
          ...
          <div className="section">
            ...
            />
            <button className="primary-button" onClick={handleLoadContract}>
              导入合约
            </button>
          </div>
          ...
          <div className="section">
            ...
            <input
              ...
              placeholder="amount"
            />
            <button className="primary-button" onClick={issueRegularPoints}>
              发行积分
            </button>
          </div>
          ...
          <div className="section">
            ...
            <button className="primary-button" onClick={getPointsBalance}>
              更新余额
            </button>
          </div>
          ...
          <div className="section">
            ...
            <button className="primary-button" onClick={exchangePoints}>
              兑换
            </button>
          </div>
        </div>
